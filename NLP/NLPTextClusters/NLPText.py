...
titles = [line.rstrip() for line in open('Text.txt')]
...
# Create our input matrices - just indicator variables for this example - works better than proportions
...
plot_k_means(Z[:,:2], current_index//10, index_word_map, show_plots=True) #naive choice K=vocabulary size divided by 10